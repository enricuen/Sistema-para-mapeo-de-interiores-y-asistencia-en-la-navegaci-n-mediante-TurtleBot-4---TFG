...
def generate_launch_description():
    turtlebot4_guidance_system = get_package_share_directory('turtlebot4_guidance_system')
    xacro_file = PathJoinSubstitution([turtlebot4_guidance_system,'urdf',LaunchConfiguration('model'),'turtlebot4.urdf.xacro'])
