...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('params',default_value=PathJoinSubstitution([pkg_turtlebot4_guidance_system, 'config', 'slam.yaml']), description='Path to the SLAM Toolbox configuration file')
]
